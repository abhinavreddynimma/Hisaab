              ...
              <LineChart data={monthlyTrend} margin={{ top: 20, right: 10, left: 10, bottom: 0 }}>
                ...
                {monthlyAvg > 0 && (
                  <ReferenceLine y={monthlyAvg} stroke="#94a3b8" strokeDasharray="4 4" strokeWidth={1}>
                    <Label value={`avg ${formatCompact(monthlyAvg)}`} position="insideTopRight" className="fill-muted-foreground" fontSize={9} dy={-2} />
                  </ReferenceLine>
                )}
                ...
                {budgetAmount && (
                  <ReferenceLine y={budgetAmount} stroke="#f59e0b" strokeDasharray="6 3" strokeWidth={1.5}>
                    <Label value={`budget ${formatCompact(budgetAmount)}`} position="insideTopLeft" className="fill-amber-600" fontSize={9} dy={-2} />
                  </ReferenceLine>
                )}
                ...
                {targetAmount && (
                  <ReferenceLine y={targetAmount} stroke="#10b981" strokeDasharray="6 3" strokeWidth={1.5}>
                    <Label value={`target ${formatCompact(targetAmount)}`} position="insideTopLeft" className="fill-emerald-600" fontSize={9} dy={-2} />
                  </ReferenceLine>
                )}
